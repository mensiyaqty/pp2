...
while True:
    ...
    1. Type "i" to INSERT data to the table.
    2. Type "u" to UPDATE data in the table.
    3. Type "q" to make specific QUERY in the table.
    4. Type "d" to DELETE data from the table.
    5. Type "s" to see the values in the table.
